local SOURCE = "https://raw.githubusercontent.com/R15ofc/v10-ravager-avionics/8d464077fd0108bf9e3aedde1489b3d80c4d190e"
local CACHE_BUST = "pinned-8d464077"
...
local FILES = {
  ...
  { source = "v10av/audio/altitude_100.dfpwm", target = "/v10av/audio/altitude_100.dfpwm", overwrite = true, binary = true },
  { source = "v10av/audio/altitude_20.dfpwm", target = "/v10av/audio/altitude_20.dfpwm", overwrite = true, binary = true },
  { source = "v10av/audio/altitude_30.dfpwm", target = "/v10av/audio/altitude_30.dfpwm", overwrite = true, binary = true },
  { source = "v10av/audio/altitude_40.dfpwm", target = "/v10av/audio/altitude_40.dfpwm", overwrite = true, binary = true },
  { source = "v10av/audio/altitude_50.dfpwm", target = "/v10av/audio/altitude_50.dfpwm", overwrite = true, binary = true },
